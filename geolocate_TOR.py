...
###   -  the TOR IP address  calling "http://httpbin.org/ip" and then https://geo.ipify.org/api/v2/country,city?apikey
###   - and info using socket session with "requests" 127.0.0.1:9050
### 
...
def get_torip_info(session,raw_ip):
    try:
        ipify = session.get("https://geo.ipify.org/api/v2/country,city?apiKey=at_YQut6Iu34iOA6O6cC00thRmi1zL0L")
        return (ipify.json())
